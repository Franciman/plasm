...
impl Plot {
    ...
    fn new(gl: &Gl, expression: &Expression, resolution: u32, camera: &Camera) -> Plot {
    ...
    fn update_positions(&mut self, expression: &Expression, resolution: u32, camera: &Camera) {
        let positions = Plot::generate_positions(expression, resolution, camera);
    ...
    fn generate_positions(expression: &Expression, resolution: u32, camera: &Camera) -> Vec<f32> {
